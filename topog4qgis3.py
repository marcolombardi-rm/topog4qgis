...
"""
/***************************************************************************
topog4qgis3		A QGIS plugin Tools for managing Topographic tool on vector
				layers
...
#		con il clickTool qui non si riesce più a prendere il comando del mouse dopo aver eseguito un comando esterno
	...
	def initGui(self):
		...
		self.action = QAction(QIcon(os.path.join(os.path.dirname(__file__), 'icon.png')),"topog4qgis3",self.iface.mainWindow())
		...
		self.iface.addPluginToMenu("topog4qgis3", self.action)
...
#		self.canvas.setMapTool(self.clickTool)
	...
	def unload(self):
		...
		self.iface.removePluginMenu("topog4qgis3",self.action)
